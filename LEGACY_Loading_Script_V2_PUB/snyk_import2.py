...
# Aligned for overlap demo: Snyk (code) side of the container pair.
# The scanTarget MUST match the Aqua side in aqua_import2-2.py
# ("phx.test/overlap-container-app"), otherwise Phoenix creates two disjoint
# assets and the demo shows no overlap at all.
send_results('scanner-sample/snyk_example.json', 'Snyk Scan', 'Overlap-code-Snyk', 'new', client_id, client_secret, "phx.test/overlap-container-app:latest")
send_results('scanner-sample/snyk_example.json', 'Snyk Scan', 'Overlap-code-Snyk2', 'new', client_id, client_secret, "phx.test/overlap-container-app:3.2")
send_results('scanner-sample/snyk_example.json', 'Snyk Scan', 'Overlap-code-Snyk3', 'new', client_id, client_secret, "phx.test/overlap-container-app:3.3")
send_results('scanner-sample/snyk_example.json', 'Snyk Scan', 'Overlap-code-Snyk4', 'new', client_id, client_secret, "phx.test/overlap-container-app:3.4")
