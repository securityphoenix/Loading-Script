...
# Aligned for overlap demo: Aqua (container) side of the container pair.
# The scanTarget MUST match the Snyk side in snyk_import2.py.
# Note: this uploads the example sample, not aqua_react2shell.json.
send_results('scanner-sample/aqua_example2.json', 'Aqua Scan', 'Overlap-container-Aqua', 'new', client_id, client_secret, "phx.test/overlap-container-app:latest")
send_results('scanner-sample/aqua_example2.json', 'Aqua Scan', 'Overlap-container-Aqua2', 'new', client_id, client_secret, "phx.test/overlap-container-app:3.2")
send_results('scanner-sample/aqua_example2.json', 'Aqua Scan', 'Overlap-container-Aqua3', 'new', client_id, client_secret, "phx.test/overlap-container-app:3.3")
send_results('scanner-sample/aqua_example2.json', 'Aqua Scan', 'Overlap-container-Aqua4', 'new', client_id, client_secret, "phx.test/overlap-container-app:3.4")
